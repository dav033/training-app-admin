...
import { CreateItem, Exercice, Routine, RoutineAllData, UpdateRoutine, RoutineSavePayload } from "@/types";
...
export const RoutineService = {
  ...
  async createOrUpdateFullRoutine(payload: RoutineSavePayload): Promise<RoutineAllData> {
    const response = await apiClient.post("/admin/routine/full", payload);
    return response.data;
  },
};
